    ...
    $.Redactor.opts = {
        ...
        langs: {
            en: {
                ...
                image: 'Insert Image',
                table: 'Table',
                link: 'Highlight words you want to add hyperlink',
        ...
        clean: function () {
            return {
                ...
                onPaste: function (html, setMode) {
                    if (isAllSelected)
                        html = isAllSelectedSubject + ' ' + html;
                    isAllSelected = false;
        ...
        link: function () {
            return {
                ...
                insert: function () {
                    ...
                    if ($.trim(link) != '' && !reminifact.test($.trim(link))) {
                        this.link.$inputUrl.addClass('redactor-input-error').on('keyup', function () {
                            $(this).removeClass('redactor-input-error');
                            $(this).off('keyup');
            ...
            return {
                ...
                loadTemplates: function () {
                    this.opts.modal = {
                        ...
                        + '<label>Only accept interlink/internal link - Link to other page within minifacts.com</label>'
							+ '<label>URL</label>'
							+ '<input type="url" id="redactor-link-url"/>'
							+ '<input type="text" style="visibility: hidden" id="redactor-link-url-text" />'
						+ '</section>'
                    };
